...
class IdeaBoardItem(models.Model):
    ...
    board_image = models.ImageField(upload_to='board_image/', max_length=100, blank=True, null=True)
    board_sound = models.FileField(upload_to='board_sounds/', blank=True, null=True)
