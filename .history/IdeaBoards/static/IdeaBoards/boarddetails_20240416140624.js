...
while (document.getElementById("board-item-" + i)) {
    document.getElementById("board-item-" + i).addEventListener("click", function() {
        let title = document.getElementById("board-item-" + i).querySelector(".card-title").textContent;
        let description = document.getElementById("board-item-" + i).querySelector(".card-description").textContent;
        
        document.getElementById("ViewItemModalLabel").textContent = title;
