...
while (document.getElementById("board-item-" + i)) {
    console.log("board-item-" + i + "-title")
    document.getElementById("board-item-" + i).addEventListener("click", function() {
        
        let title = document.getElementById("board-item-" + i + "-title").textContent;
        let description = document.getElementById("board-item-" + i + "-description").textContent;
